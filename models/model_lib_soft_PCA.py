...
class PCA_NN_PCA_ADD(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        relu_nn = []
        # Soft PcaLayer is a trainable layer. while the PcaLayer in model_lib_PCA.py is initialized with one PCA operation and hence not trainable. 
        # We want to make sure the depth counting is consistent between these two versions.
        if nn_depth == -1:
            # infer nn_depth
